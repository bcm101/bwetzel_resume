...
const daily_sudoku = function () {
    return [
        ...
        {line: "The algorithm for counting solutions is a recursive, backtracking approach that backtracks only when encountering conflicts between cells. To improve efficiency, the algorithm prioritizes filling cells with many neighboring filled-in cells. This drastically increases the likelyhood of finding possible solutions quickly if any exist.", remove_spaces: true, className: "opened-file"},
